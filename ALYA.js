...
const sayiEmojiler = {
  0: "<a:sifir:780009108467744788>",
  1: "<a:bir:780009100795838494>",
  2: "<a:iki:780009108271136799>",
  3: "<a:uc:780009108295778316>",
  4: "<a:dort:780009108199440404>",
  5: "<a:bes:780009092243783700>",
  6: "<a:alti:780009091837460490>",
  7: "<a:yedi:780009107955515393>",
  8: "<a:sekiz:780009108497367071>",
  9: "<a:dokuz:780009109171863562>"
};
...
client.emojiler = {
  onay: "779047833276907571",
  iptal: "779047758886993950",
  cevrimici: "779047863819829278",
  rahatsizetmeyin: "779047858874875945",
  bosta: "779047859781763072",
  gorunmez: "779047863044276224",
  erkekEmoji: "779047776922894336",
  kizEmoji: "779047786418274346",
  gif1: "780074324819181628",
  gif2: "780074324819181628",
  gif3: "780074324819181628",
  gif4: "780074324819181628"
};
...
member.roles.add("781481005076840461")})


/*client.on('userUpdate', async user => {
  let sunucu = client.guilds.cache.get('777285686633300008'); //Buraya sunucunuzun IDsini yazın
  let tag = "✮"; //Buraya tagınızı yazın
  let rol = "781480988710010891"; //Buraya tag alındığı zaman verilecek rolün IDsini yazın
  let channel = sunucu.channels.cache.find(x => x.id == '781481168024633354'); //tagrol-log yerine kendi log kanalınızın ismini yazabilirsiniz
  if (!tag) return;
  if (!rol) return;
  if (!channel) return;
